...
export const DropdownSubmenuTrigger = SubmenuTrigger;
export const DropdownPopover = Popover;
...
export function DropdownMenuContent({
  ...
  return (
    <Popover {...props}>
      <Menu
        className={cn(
          "outline-hidden rounded-xl overflow-clip min-w-40 bg-dropdown-background",
          className,
        )}
      >
        {children}
