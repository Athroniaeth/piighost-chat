  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div
          className={cn(
            "absolute top-1/2 left-0.5 flex -translate-y-1/2 items-center justify-center rounded-full bg-toggle-ball-background peer-disabled:bg-toggle-disabled-foreground shadow-sm transition-all duration-200 ease-in-out peer-checked:left-[calc(100%-0.125rem)] peer-checked:-translate-x-full",
            {
              "size-4": size === "sm",
              "size-5": size === "md",
            },
